...
home: {
  ...
  hero: {
    titleLine1: "Devis, réservations et factures.",
    titleLine2: "Tout au même endroit.",
    sub: "Tradie aide les professionnels à gérer leurs clients, se faire réserver, envoyer des factures et être payés, sans tableur ni abonnement supplémentaire.",
  ...
  features: {
    ...
    booking: {
      ...
      title: "Les clients réservent eux mêmes",
      desc: "Partagez un lien. Les clients choisissent une prestation, laissent leurs coordonnées et reçoivent une confirmation automatiquement.",
      bullet1: "Une page de réservation publique pour votre activité",
      bullet2: "Des prestations réservables avec photos et prix",
      bullet3: "Acceptez ou refusez les demandes depuis une seule boîte de réception",
      visual: {
        name: "Jake Morrison",
        badge: "Page de réservation en ligne",
        service1: "Consultation",
        service2: "Prestation complète",
        cta: "Demander une réservation",
      },
    },
    quotes: {
      tabLabel: "Devis",
      title: "Envoyez des devis que vos clients signent aussitôt",
      desc: "Créez un devis avec des lignes détaillées, envoyez le, et laissez vos clients l'accepter par signature électronique.",
      bullet1: "Des lignes pour la main d'œuvre et le matériel",
      bullet2: "Signature du client intégrée au devis",
      bullet3: "Convertissez un devis accepté en mission en un clic",
      visual: {
        number: "DEV 0032",
        status: "Accepté",
        line1: "Main d'œuvre",
    ...
    invoices: {
      tabLabel: "Factures",
      title: "Faites payer vos factures plus vite",
      desc: "Envoyez des factures professionnelles par email, acceptez les paiements par carte ou par virement, et relancez automatiquement les factures en retard.",
      bullet1: "Paiement par carte ou par virement sur chaque facture",
      bullet2: "Relances automatiques des factures en retard",
      bullet3: "Envoi en PDF et par email en un clic",
      visual: {
        number: "FAC 0847",
        status: "Payée",
        billTo: "Facturé à",
        client: "Sarah Mitchell",
        line: "Prestations effectuées",
        totalLabel: "Total dû",
      },
    },
    payments: {
      tabLabel: "Paiements",
      title: "Soyez payé sans changer de banque",
      desc: "Tradie Pay traite les paiements par carte avec des frais fixes de deux pour cent, sans abonnement mensuel requis.",
      bullet1: "Deux pour cent de frais fixes, sans abonnement",
      bullet2: "Les versements arrivent sur votre compte bancaire existant",
      bullet3: "Le détail des frais sur chaque transaction",
      visual: {
        title: "Détail des frais",
    ...
    clients: {
      ...
      desc: "Gardez un historique complet des missions, devis et factures pour chaque client, consultable en quelques secondes.",
      bullet1: "Historique complet des missions et factures par client",
      bullet2: "Recherche et filtres instantanés",
      bullet3: "Aucun tableur nécessaire",
      visual: {
        title: "Clients",
        client1: "Sarah Mitchell",
        client2: "Robert Chen",
        client3: "Emma Lawson",
        jobsLabel: "missions",
      },
    ...
    growth: {
      tabLabel: "Croissance",
      title: "Transformez vos clients satisfaits en nouvelles opportunités",
      desc: "Demandes d'avis automatiques, programme de parrainage et une place de marché pour vous aider à grandir.",
      bullet1: "Demandes d'avis automatiques envoyées par SMS",
      bullet2: "Récompenses de parrainage pour chaque recommandation",
      bullet3: "Une place de marché pour le matériel, les ventes et le recrutement",
      visual: {
        reviewsLabel: "Note moyenne",
        reviewsCount: "47 avis",
        referralTitle: "Parrainez un confrère",
        referralDesc: "Les deux comptes reçoivent deux mois offerts",
      },
    },
  },
  pricing: {
    ...
    sub: "Aucun abonnement requis pour facturer et être payé. Passez à un forfait supérieur quand vous en avez besoin.",
    mostPopular: "Le plus choisi",
    perMonth: "/mois",
    cta: "Essai gratuit",
    plans: {
      free: { name: "Gratuit", sub: "Plus deux pour cent sur les paiements" },
      pro: { name: "Pro", sub: "Le plus choisi, essai gratuit inclus" },
      team: { name: "Équipe", sub: "Jusqu'à cinq membres" },
    },
  },
  finalCta: {
    title: "Créez votre page de réservation en quelques minutes",
    sub: "Gratuit pour démarrer. Sans carte bancaire.",
    cta: "Essai gratuit",
  },
  footer: {
    contact: "Contact",
    copyright: "© 2026 Tradie.",
  },
},
}
