...
home: {
  ...
  hero: {
    titleLine1: "Quotes, bookings and invoices.",
    titleLine2: "All in one place.",
    sub: "Tradie helps professionals manage clients, get booked, send invoices and get paid, without spreadsheets or extra subscriptions.",
  ...
  features: {
    ...
    booking: {
      ...
      desc: "Share one link. Clients pick a service, leave their details and get a confirmation automatically.",
      bullet1: "A public booking page for your business",
      bullet2: "Bookable services with photos and pricing",
      bullet3: "Accept or decline requests from one inbox",
      visual: {
        name: "Jake Morrison",
        badge: "Booking page live",
        service1: "Consultation",
        service2: "Full service",
        cta: "Request a booking",
      },
    },
    quotes: {
      tabLabel: "Quotes",
      title: "Send quotes clients can sign instantly",
      desc: "Build a quote with line items, send it, and let clients accept it with an electronic signature.",
      bullet1: "Line items for labour and materials",
      bullet2: "Client signature built into the quote",
      bullet3: "Convert an accepted quote into a job in one click",
      visual: {
        number: "QUO 0032",
        status: "Accepted",
        line1: "Labour",
    ...
    invoices: {
      ...
      desc: "Send professional invoices by email, accept card payments or bank transfer, and chase overdue ones automatically.",
      bullet1: "Card payments or bank transfer on every invoice",
      bullet2: "Automatic reminders for overdue invoices",
      bullet3: "PDF and email delivery in one click",
      visual: {
        number: "INV 0847",
        status: "Paid",
        billTo: "Bill to",
        client: "Sarah Mitchell",
        line: "Services rendered",
        totalLabel: "Total due",
      },
    },
    payments: {
      tabLabel: "Payments",
      title: "Get paid without changing banks",
      desc: "Tradie Pay processes card payments at a flat two percent fee, with no monthly subscription required.",
      bullet1: "Two percent flat fee, no subscription",
      bullet2: "Payouts land in your existing bank account",
      bullet3: "A full fee breakdown on every transaction",
      visual: {
        title: "Fee breakdown",
    ...
    clients: {
      ...
      desc: "Keep a full history of jobs, quotes and invoices for every client, searchable in seconds.",
      bullet1: "Full job and invoice history per client",
      bullet2: "Search and filter instantly",
      bullet3: "No spreadsheets required",
      visual: {
        title: "Clients",
    ...
    growth: {
      tabLabel: "Growth",
      title: "Turn happy clients into new business",
      desc: "Automatic review requests, a referral programme and a marketplace to help you grow.",
      bullet1: "Automatic review requests sent by SMS",
      bullet2: "Referral rewards for every introduction",
      bullet3: "A marketplace for materials, sales and hiring",
      visual: {
        reviewsLabel: "Average rating",
        reviewsCount: "47 reviews",
        referralTitle: "Refer a colleague",
        referralDesc: "Both accounts get two months free",
      },
    },
  },
  pricing: {
    ...
    sub: "No subscription required to invoice and get paid. Upgrade whenever you need more.",
    mostPopular: "Most popular",
    perMonth: "/mo",
    cta: "Start free",
    plans: {
      free: { name: "Free", sub: "Plus two percent on payments" },
      pro: { name: "Pro", sub: "Most chosen, free trial included" },
      team: { name: "Team", sub: "Up to five members" },
    },
  },
  finalCta: {
    title: "Set up your booking page in minutes",
    sub: "Free to start. No card required.",
    cta: "Start free",
  },
  footer: {
    contact: "Contact",
